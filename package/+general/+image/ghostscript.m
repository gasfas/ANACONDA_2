...
function varargout = ghostscript(cmd)
    try
        ...
        hg2_str = ''; if general.image.using_hg2, hg2_str = ' or Matlab R2014a'; end
...
path_ = general.image.user_string('ghostscript');
...
if ~general.image.user_string('ghostscript', path_)
    warning('Path to ghostscript installation could not be saved. Enter it manually in %s.', fullfile(fileparts(which('general.image.user_string.m')), '.ignore', 'ghostscript.txt'));
    return
end
end
