...
% The events file can be with or without header:
if cell2mat(strfind(d_e.VariableNames,'eventId_'))
%  	IO.EPICEA.ASCII_2_mat_one(events_path, {'eventId_', 'num_E_', 'num_I_', 'num_RandomHits' });
    IO.EPICEA.ASCII_2_mat_one(events_path, {'eventId_', 'num_E_', 'num_RandomHits'});
else
	IO.EPICEA.ASCII_2_mat_one(events_path, {'Var1', 'Var2', 'Var6'});
end
