function [xdata, yfitdata, ybgr, IG, LB, UB, options] = ind_peak_fit_prep(fit_md, m2q, m2q_bgr)
% Individual peak fitting preparation
% This is a convenience function to define the boundary conditions to the
% size-dependent least-square binomial fit 
% Input:
% fit_md    The fit metadata, struct
% m2q       The m2q value of all hits [n,1]
% Output:
% xdata the xdata (m2q values), [m,1]
% ydata the corresponding intensities [m,1]
