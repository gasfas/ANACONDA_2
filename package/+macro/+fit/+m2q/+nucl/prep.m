...
% This function prepares the fitting parameters and data for the nucleation model (a smaller cluster group spectrum onto a cluster is projected onto a group one 'q' higher).
% Inputs:
...
% The fit parameters have a different format for each type of fit. In this case, the optimization parameters are as follows:
% p_m_q
% peak height
% Gaussian width:
% noise level:
