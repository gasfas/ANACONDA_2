function [ labeled_s2, l_hit_loc ] = label_2_label(labeled_s1, labels1, labels2, rest_label)
...
[ filt, l_hit_loc ]          = filter.hits.labeled_hits(labeled_s1, labels1);
% Fill in the labels:
labeled_s2(filt, :)        = labels2(l_hit_loc(filt), :);
