function [h_GraphObj] = patch1(h_axes, midpoints, Count, GraphObj_md)
...
p = patch(h_axes, isosurface(x, y, z, Count, xyt));
h_GraphObj = isonormals(x,y,z,Count,p);
% hold on
% h_GraphObj= isocolors(x,y,z,xyt,p);
