...
r(2) = text(1-rel_pos*sin(deg2rad(30))+dist*cos(deg2rad(30)), rel_pos*cos(deg2rad(30)) + dist*sin(deg2rad(30)), B, 'rotation', -60, 'horizontalalignment', 'center', 'FontSize', 20);
r(3) = text(rel_pos*sin(deg2rad(30))-dist*cos(deg2rad(30)), rel_pos*cos(deg2rad(30)) + dist*sin(deg2rad(30)), C, 'rotation', 60, 'horizontalalignment', 'center', 'FontSize', 20);
