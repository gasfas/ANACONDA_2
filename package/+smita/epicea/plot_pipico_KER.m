function [Tet_tof2] = plot_pipico_KER(data_converted, data_stats,e_filter_et,e_filter_rt);
SC = data_stats.SC;
TP_0 =data_stats.TP_0;

%% Create TOF distribution
Binsize = 0.1; Binedges = 0: Binsize: 5;
...
et_tof_c1= data_converted.h.det2.KER(hit_filter_et_c1.det2.filt);
...
rt_tof_c1= data_converted.h.det2.KER(hit_filter_rt_c1.det2.filt);
