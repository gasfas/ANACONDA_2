function [Tet_tof2] = plot_p_norm_p_norm(data_converted, data_stats,roi,m2q_1,m2q_2);
SC = data_stats.SC;
TP_0 =data_stats.TP_0;

data_converted.h.det2.dp_x = data_converted.h.det2.dp_norm;%(:,3);

[e_filter_roi, ~] = filter.epicea.find_events_in_roi(data_converted,roi,m2q_1,m2q_2);

%% Create TOF distribution
Binsize = 10; Binedges = 0: Binsize: 400;
...
et_tof_c1= data_converted.h.det2.dp_x(hit_filter_et_c1.det2.filt);
...
rt_tof_c1= data_converted.h.det2.dp_x(hit_filter_rt_c1.det2.filt);
