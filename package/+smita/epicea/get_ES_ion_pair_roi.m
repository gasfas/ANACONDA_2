function [xvalues, c, d] = get_ES_ion_pair_roi(roi_path,data_converted, data_stats)
...
%    if c1== 2 && h1 == 3% && c2== 6 && h2 == 7
    ...
    [e_KE_mean,e_KE_std,e_KE_mode] = plot_ES_ion_pair_c2(data_converted, data_stats,roi.roi,tof_1,tof_2);
