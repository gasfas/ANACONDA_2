function [TES2IIpair_x] = plot_ES_ion_pair2(data_converted, data_stats,roi,tof1,tof2)
...
figure
hold on
plot(Xcenters,ES2IIpair_x,'DisplayName','ES2IIpair_x_j(x)')
plot(Xcenters,BES2IIpair_x,'DisplayName','BES2IIpair_x_j(x)')% colorbar
% plot(Xcenters,TES2IIpair_x,'DisplayName','TES2IIpair_x_j(x)')% colorbar
errorbar(Xcenters,TES2IIpair_x,TES2IIpair_x_error,'DisplayName','TES2IIpair_x_j(x)')% 
legend
% caxis([0 800])
