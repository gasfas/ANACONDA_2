...
% Create the load scan window
    ...
    UI_obj.load_scan.LoadFile_Browse_btn  = uibutton(UI_obj.load_scan.f_open_scan, "Text", "Browse", "Position", [10, 10, 80, 20], "ButtonPushedFcn", {@GUI.fs_big.load_scan.callback.get_filepath, GUI_settings, UI_obj});
    UI_obj.load_scan.LoadFile_Cancel_btn  = uibutton(UI_obj.load_scan.f_open_scan, "Text", "Cancel", "Position", [410, 10, 80, 20], "ButtonPushedFcn", {@GUI.fs_big.load_scan.callback.load_scan_cancel_callback, GUI_settings});
    UI_obj.load_scan.LoadFile_Ok_btn      = uibutton(UI_obj.load_scan.f_open_scan, "Text", "Ok", "Position", [500, 10, 80, 20], "ButtonPushedFcn", {@GUI.fs_big.load_scan.callback.load_scan_OK_callback, GUI_settings, is_modify_scan});
