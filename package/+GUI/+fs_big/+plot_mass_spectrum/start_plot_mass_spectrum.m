...
UI_obj.plot.m2q.remember_linechbx   = uibutton(UI_obj.plot.m2q.main, 'Text', 'Store line', 'Position', [10, 10, 60, 25], ...
                        'ButtonPushedFcn', @remember_line, 'Tooltip', GUI_settings.plot_m2q.tooltips.remember_linechbx);
UI_obj.plot.m2q.clear_graph_pushbtn = uibutton(UI_obj.plot.m2q.main, 'Text', 'Clear', 'Position', [80, 10, 60, 25], ...
...
UI_obj.plot.m2q.smooth_edit         = uieditfield(UI_obj.plot.m2q.main,"numeric", 'Value', 1, ...
                        'Tooltip', GUI_settings.plot_m2q.tooltips.smooth, 'Position', [210, 10, 35, 25], 'ValueChangedFcn', @change_spectrum_within_scan);
UI_obj.plot.m2q.smooth_label        = uilabel(UI_obj.plot.m2q.main, 'Text', 'smooth', ...
                        'Tooltip', GUI_settings.plot_m2q.tooltips.smooth, 'Position', [250, 10, 50, 25]);
...
if numel(fieldnames(exp_data.spectra)) >= 1
    ...
    UI_obj.plot.m2q.spectra.uitable = uitable(UI_obj.plot.m2q.uitabgroup.spectra, ...
                "ColumnName", {'Name', 'dY', 'Scale', 'Color'}, "Position",[5 5 320 220], 'ColumnEditable', [false true true, false], ...
...
if numel(fieldnames(exp_data.scans)) >= 1
    ...
    UI_obj.plot.m2q.spectr_slider.Position(1:3) = [35, 155, 230];
    ...
    UI_obj.plot.m2q.dropdownscans = uidropdown(UI_obj.plot.m2q.uitabgroup.scans, 'Items', scan_usernames, ...
        'ValueChangedFcn', @change_sample_dropdown_callback, 'Position', [25, 175, 120, 25]);
    ...
    UI_obj.plot.m2q.slider_text = uilabel(UI_obj.plot.m2q.uitabgroup.scans, 'Text', 'Photon energy:', 'Position', [165, 175, 120, 25], ...
...
function[hLine] = update_plot(ax, exps, datatype, sample_name, spectrum_number)
    ...
    UI_obj.plot.m2q.cur_line           = plot(UI_obj.plot.m2q.axes, M2Q_data.bins, M2Q_data.I, 'DisplayName', LineName_leg);
    % try 
