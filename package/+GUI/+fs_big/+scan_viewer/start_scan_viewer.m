...
UI_obj.main.plot_m2q.uibutton       = uibutton(UI_obj.main.uifigure, "Text", "Plot M/Q", "Position", [button_xpos, 400, button_width_x, button_height_y], ...
...
UI_obj.main.plot_scan.uibutton      = uibutton(UI_obj.main.uifigure, "Text", "Plot scan", "Position", [button_xpos, 370, button_width_x, button_height_y], ...
...
UI_obj.main.normalize.uibutton      = uibutton(UI_obj.main.uifigure, "Text", "Normalize", "Position", [button_xpos, 340, button_width_x, button_height_y], ...
...
UI_obj.main.subtract.uibutton       = uibutton(UI_obj.main.uifigure, "Text", "Subtract", "Position", [button_xpos, 310, button_width_x, button_height_y], ...
...
UI_obj.main.Remove_spectrum             = uibutton(UI_obj.main.uifigure, "Text", "Remove spectrum", "Position", [button_xpos, 250, button_width_x, button_height_y], ...
