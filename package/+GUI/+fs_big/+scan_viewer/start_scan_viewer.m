...
UI_obj.main.correct.uibutton            = uibutton(UI_obj.main.uifigure, "Text", "Correct", "Position", [button_xpos, 400, button_width_x, button_height_y], ...
                                            'Tooltip', GUI_settings.scan_view.tooltips.plot_m2q);
UI_obj.main.define_fragments.uibutton   = uibutton(UI_obj.main.uifigure, "Text", "Define fragments", "Position", [button_xpos, 370, button_width_x, button_height_y], ...
