...
UI_obj.main.Remove_spectrum             = uibutton(UI_obj.main.uifigure, "Text", "Remove spectrum", "Position", [button_xpos, 400, button_width_x, button_height_y], ...
...
% scan:
UI_obj.main.Remove_scan             = uibutton(UI_obj.main.uifigure, "Text", "Remove scan", "Position", [button_xpos, 200, button_width_x, button_height_y], ...
...
UI_obj.main.Modify_scan             = uibutton(UI_obj.main.uifigure, "Text", "Modify scan", "Position", [button_xpos, 170, button_width_x, button_height_y], ...
...
UI_obj.main.plot_m2q.uibutton       = uibutton(UI_obj.main.uifigure, "Text", "Plot M/Q", "Position", [button_xpos, 110, button_width_x, button_height_y], ...
...
UI_obj.main.plot_scan.uibutton      = uibutton(UI_obj.main.uifigure, "Text", "Plot scan", "Position", [button_xpos, 80, button_width_x, button_height_y], ...
