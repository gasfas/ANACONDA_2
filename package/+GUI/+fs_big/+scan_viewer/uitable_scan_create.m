...
UI_obj.main.scans.uitable                  = uitable(UI_obj.main.uifigure, ...
    "ColumnName", UI_obj.main.scans.Properties.VariableNames, "Position",[10 40 440 190]);
...
UI_obj.main.scans.uitable.ColumnWidth      = {180, 30, 50, 50, 'auto'};
