% Description: Removes the selected user defined/customized plot configuration for the selected experiment(s)
%   - inputs:
...
if length(sel_plot_conf) == 2
    if ~strcmp(char(sel_plot_conf(2)), 'In_Workspace')
        ...
        GUI.log.add('Cannot remove the plot configuration in workspace.');
    end
end
end