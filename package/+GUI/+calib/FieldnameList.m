...
function [fieldvalueselected] = FieldnameList(hObject, eventdata, UICalib)
    ...
    switch UICalib.h_calib_tabs.SelectedTab.Title
        case 'correction'
            if md_GUI.calib.correction.caliblistval == fieldvalueselected
                    ...
                    set(UICalib.correction.Fieldvalue, 'Value', fieldvalueselected);
        ...
        case 'conversion'
            if md_GUI.calib.conversion.caliblistval == fieldvalueselected
                    ...
                    set(UICalib.conversion.Fieldvalue, 'Value', fieldvalueselected);
