...
GUI.filter.edit.Add_Filter_Choice;

prompt = {'Type the new filter name.';'Select experiment number to insert the new filter into.'};
name = 'New Filter';
...
exp_names = fieldnames(md_GUI.mdata_n);
formats(2,1).items  = exp_names;
defaultanswer = {'NewFilterName', 1};
