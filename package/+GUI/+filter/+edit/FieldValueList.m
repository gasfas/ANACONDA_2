% Description: Sets the FieldnameList to same position and updates
...
function [fieldvalueselected] = FieldValueList(hObject, eventdata, UIFilter)
...
if md_GUI.filter.filterlistval == fieldvalueselected
    ...
    set(UIFilter.Fieldname, 'Value', fieldvalueselected);
