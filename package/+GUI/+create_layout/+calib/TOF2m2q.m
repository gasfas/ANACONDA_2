...
UI.Radio_CalibType_Ions = uicontrol('Parent', tab_calib, ...
'Style','radiobutton',...
'Units', 'normalized',...
'Position',[0.55 0.92 0.40 0.06],...
'FontSize', 11, ...
'String','ion');

UI.Radio_CalibType_Electrons = uicontrol('Parent', tab_calib, ...
'Style','radiobutton',...
'Units', 'normalized',...
'Position',[0.55 0.85 0.40 0.06],...
'FontSize', 11, ...
'String','electron');
