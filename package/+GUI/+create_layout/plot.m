...
function [ h_figure, UI ] = plot( h_figure, pos, h_tabs, tab_plot)
%% Functions
...
UI.InformationText_LoadedFilesPlotting = uicontrol('Parent', tab_plot, ...
'Style','text',...
'Units', 'normalized',...
...
UI.LoadedFilesPlotting = uicontrol('Parent', tab_plot, ...
'Style', 'listbox', ...
'Units', 'normalized', ...
'Position', [0.02 0.76 0.96 0.20], ...
'FontSize', 14, ...
'Enable', 'on', ...
'String', {''}, ...
'Max',2,'Min',0,...
