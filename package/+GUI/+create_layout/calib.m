...
% % Information about the listbox below
 UIctrl_calib.h_calib_tabs = uitabgroup(tab_calib,'Position',[0 0 1 0.80]);
% TOF2m2q tab
...
% %% New Plotting:
 [h_figure, UIctrl_calib.momentum]        = GUI.create_layout.calib.momentum(h_figure, pos, UIctrl_calib.h_calib_tabs, UIctrl_calib.tab_momentum);
