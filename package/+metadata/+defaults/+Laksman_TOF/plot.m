...
% Condition metadata:
% d1.TOF_hit1_hit2.cond			= exp_md.cond.incompl;
d1.TOF_hit1_hit2.cond			= exp_md.cond.PEPIPICO_article;
...
% d1.m2q_hit1_hit2.hist.bgr		= metadata.create.plot.signal_2_plot({signals.m2q_bgr, signals.m2q_bgr});
% d1.m2q_hit1_hit2.hist.bgr.hist.hitselect = [1, 2]; %hitselect can be used to select only the first, second, etc hit of a hit variable.
% d1.m2q_hit1_hit2.hist.bgr.weight	= 0.05;

% d1.m2q_hit1_hit2.hist.binsize = [17 17];
...
d1.m2q_hit1_hit2.axes.XLim		= [16.5 18.5];
d1.m2q_hit1_hit2.axes.YLim		= [31.5 36.5];
d1.m2q_hit1_hit2.axes.XTick		= [17 18];
d1.m2q_hit1_hit2.axes.XTickLabel= d1.m2q_hit1_hit2.axes.XTick;
d1.m2q_hit1_hit2.axes.YTick		= [16 17 32 33 34 35 36];
d1.m2q_hit1_hit2.axes.YTickLabel= d1.m2q_hit1_hit2.axes.YTick;
% d1.m2q_hit1_hit2.axes			= macro.plot.add_axes(d1.m2q_hit1_hit2.axes(1), signals.add_cluster_size.axes, exp_md.sample, 'cluster_size');
d1.m2q_hit1_hit2.figure.Position = [1200 1000 600 350];
% d1.m2q_hit1_hit2.cond			= exp_md.cond.angle_p_corr_C2;
% d1.m2q_hit1_hit2.cond			= exp_md.cond.PEPIPICO_article;
...
d1.m2q_hit2_hit3.cond			= exp_md.cond.angle_p_corr_C3;
d1.m2q_hit2_hit3.cond.label		= exp_md.cond.def.label;
d1.m2q_hit2_hit3.cond.label.value	= [52];
d1.m2q_hit2_hit3.cond.label.type	= 'discrete';
d1.m2q_hit2_hit3.cond.label.translate_condition = 'hit1';
...
d1.Dalitz_C2.axes.YLabel.String		= '$|p_2|$ (NH$_3^+$) [a.u.]';
...
d1.angle_p_corr_C2.cond			= exp_md.cond.N_H;

d1.KER_sum							= metadata.create.plot.signal_2_plot({signals.KER_sum});
d1.KER_sum.hist.Integrated_value	= 1;
d1.KER_sum.cond						= exp_md.cond.incompl;
% d1.KER_sum.cond						= exp_md.cond.NH_H;
...
% d1.m2q_l_sum_KER_sum.GraphObj.Type	= 'imagesc';
