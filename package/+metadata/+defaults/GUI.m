...
md_GUI.filter.common_filters.Combined_Filter.EventsFilter.type = continuous;
md_GUI.filter.common_filters.Combined_Filter.EventsFilter.value = [0 40];
md_GUI.filter.common_filters.Combined_Filter.EventsFilter.data_pointer = e.det1.m2q_l_sum;
md_GUI.filter.common_filters.Combined_Filter.HitsFilter.type = discrete;
md_GUI.filter.common_filters.Combined_Filter.HitsFilter.value = [0 5 10 15 20 25 30 35 40];
md_GUI.filter.common_filters.Combined_Filter.HitsFilter.data_pointer = h.det1.m2q_l;
%% Plot
