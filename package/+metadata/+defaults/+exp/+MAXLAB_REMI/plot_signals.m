...
s.e_mult.hist.pointer	= 'e.det2.mult';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% electron Radius:
s.e_R.hist.pointer		= 'h.det2.R';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%% electron Theta:
s.e_Theta.hist.pointer		= 'h.det2.theta';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% electron TOF:
s.e_TOF.hist.pointer		= 'h.det2.TOF';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% electron X:
s.e_X.hist.pointer		= 'h.det2.X';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% electron Y:
s.e_Y					= s.e_X;
s.e_Y.hist.pointer		= 'h.det2.Y';% Data pointer, where the signal can be found. 
% Axes metadata:
s.e_Y.axes.Label.String	= 'Y [mm]'; %The label of the variable

%%%%%% electron dpx:
s.e_dpx.hist.pointer		= 'h.det2.dp(:,1)';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% electron dpy:
s.e_dpy						= s.e_dpx;
s.e_dpy.hist.pointer		= 'h.det2.dp(:,2)';% Data pointer, where the signal can be found. 
...
%%%%%% electron dpz:
s.e_dpz                     = s.e_dpx;
s.e_dpz.hist.pointer		= 'h.det2.dp(:,3)';% Data pointer, where the signal can be found.
...
%%%%%% Momentum:
s.e_dp.hist.pointer	= 'h.det2.dp';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
s.e_PolAngleXYZ.hist.pointer        = 'h.det2.AzAngle3D';
...
s.e_PolAngleYZ.hist.pointer         = 'h.det2.PolarPyPz';
...
s.e_PolAngleXZ.hist.pointer         = 'h.det2.PolarPxPz';
...
s.e_KER_sum.hist.pointer	= 'h.det2.KER';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
s.KERoverAngleUp.hist.pointer         = 'h.det2.KERoverAngleUp';
...
%%%%%% mult: (multiplicity of the event)
s.i_mult.hist.pointer	= 'e.det1.mult';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% X:
s.i_X.hist.pointer		= 'h.det1.X';% Data pointer, where the signal can be found. 
% Histogram metadata:
s.i_X.hist.binsize		= 0.5;% [mm] binsize of the variable. 
s.i_X.hist.Range			= [-10 10];% [mm] range of the variable. 
% Axes metadata:
...
s.i_Y.hist.pointer		= 'h.det1.Y';% Data pointer, where the signal can be found. 
...
s.i_R.hist.pointer		= 'h.det1.R';% Data pointer, where the signal can be found. 
...
%%%%%% Mass-to-charge sum:
s.i_m2q_l_sum.hist.pointer	= 'e.det1.m2q_l_sum';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% Momentum:
s.i_dp.hist.pointer	= 'h.det1.dp';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% Momentum norm:
s.i_p_norm.hist.pointer	= 'h.det1.p_norm';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% Momentum sum:
s.i_p_sum.hist.pointer	= 'e.det1.p_sum';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% Momentum sum norm:
s.i_p_sum_norm.hist.pointer	= 'e.det1.p_sum_norm';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
s.i_dpx.hist.pointer		= 'h.det1.dp(:,1)';% Data pointer, where the signal can be found. 
...
s.i_dpy.hist.pointer		= 'h.det1.dp(:,2)';% Data pointer, where the signal can be found. 
...
s.i_dpz.hist.pointer		= 'h.det1.dp(:,3)';% Data pointer, where the signal can be found.
...
s.i_angle_p_corr_C2.hist.pointer	= 'e.det1.angle_p_corr_C2';% Data pointer, where the signal can be found. 
% Histogram metadata:
...
%%%%%% Kinetic Energy Release:
s.i_KER_sum.hist.pointer	= 'e.det1.KER_sum';% Data pointer, where the signal can be found. 
% Histogram metadata:
