...
exp_md.det.det1.name	 		= 'Roentdek HEX X,Y,T detector';
exp_md.det.det1.max_radius 		= 40 ; % [mm] Radius of the detector
exp_md.det.det1.signals			= {'X [mm]', 'Y [mm]'} ; %name of output signals of the detector.
exp_md.det.det1.Front_Voltage  	= 300; %[V]  Detector front potential.
...
exp_md.det.det1.Eff.Gilmore.Age_factor	= 1; % Correction of the detection efficiency curve from Gilmore, increases with MCP age.

% Detector 2 %% Detector 2 %% Detector 2 %% Detector 2 %% Detector 2 %% Detector 2 %% Detector 2 %% Detector 2 %
exp_md.det.det2.name	 		= 'Roentdek DLD X,Y,T detector';
...
exp_md.det.det2.Front_Voltage  	= -3000; %[V]  Detector front potential.
exp_md.det.det2.pol_direction	= [1 0 0]; %[-] The polarization direction in this detector.
