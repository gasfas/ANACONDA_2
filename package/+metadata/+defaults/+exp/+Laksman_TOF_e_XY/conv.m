...
exp_md.conv.det2.ifdo.m2q_group					= true; % Does the user want to convert to mass-2-charge groups?
exp_md.conv.det2.ifdo.m2q_label_Ci				= true; % Does the user want to convert to mass-2-charge labels?
