...
exp_md.corr.crossdet.ifdo.ionization_position = true;
...
exp_md.corr.crossdet.ionization_position.source.detnr = 2;
exp_md.corr.crossdet.ionization_position.subject.detnr = 2;
exp_md.corr.crossdet.ionization_position.X_fraction   = 0.3;
exp_md.corr.crossdet.ionization_position.Y_fraction   = 0.5;
end
