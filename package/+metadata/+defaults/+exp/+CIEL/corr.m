...
exp_md.corr.det1.ifdo.dXdY 			= false;% Does this data need detector image translation correction?
...
% The detector image translation parameters:
exp_md.corr.det2.dX					= 3.0;   %[mm] distance the center of detection is displaced left of the origin of the raw image; 
exp_md.corr.det2.dY					= 6.0;   %[mm] distance the center of detection is displaced up the origin of the raw image;
% The detector image rotation parameters:
