...
% Time Of Flight to Mass to Charge calibration
exp_md.conv.det2.TOF_2_m2q.factor      	= 1959;%Conversion factor from mass 2 charge to TOF
exp_md.conv.det2.TOF_2_m2q.t0          	= 0;%[ns] dead time correction
...
exp_md.conv.det2.m2q_label.search_radius= 1; % search radius (in either m/q or nsec units, depending on the labelling_signal indicated), or searchwidth around the main expectation value (no-Kinetic energy point).
