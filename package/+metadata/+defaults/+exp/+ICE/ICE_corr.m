function [ exp_md ] = ICE_corr ( exp_md )
...
exp_md.corr.det1.ifdo.R_circle		= false;% is there non-roundness in the cylindrically symmetric data?

% The detector image translation parameters:
exp_md.corr.det1.dX					= -5.0;   %[mm] distance the center of detection is displaced left of the origin of the raw image; 
...
% The detector image translation parameters:
exp_md.corr.det2.dX					= -9.5;   %[mm] distance the center of detection is displaced left of the origin of the raw image; 
exp_md.corr.det2.dY					= 2.0;   %[mm] distance the center of detection is displaced up the origin of the raw image;
% The detector image rotation parameters:
